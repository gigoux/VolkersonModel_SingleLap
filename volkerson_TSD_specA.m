...
t_o = 0.1267 * 0.0254; %outer adherend thickness [m]
t_i = 0.1268 * 0.0254; %inner adherend thickness [m]
G_a = 0.6e9; %adhesive shear modulus [Pa]
G_o = 2.6e9; %outer adherend shear modulus [Pa]
G_i = 2.6e9; %inner adherend shear modulus [Pa]
t_tot = 0.256 * 0.0254; %total thickness (adherends + adhesive) [m]
c = (1.598 * 0.0245) / 2; %half of bonded length [m]
w_t = 1.0483 * 0.0254; %specimen width [m]
N_x = 8.6388e03 / w_t; %applied axial loading [N/m]
...
title('Shear Stress Profile for Specimen A');
legend('Volkerson OG', 'Volkerson TSD', 'Average Shear Stress', ...
    'Ultimate Shear Stress', 'Location', 'best');
...
title('Outer Adherend Axial Stress Profile for Specimen A');
